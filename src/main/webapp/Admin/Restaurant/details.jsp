    ...
    <div class="row m-0" style="height: 100%">
      ...
      <div class="col-9 bg-light px-4 d-flex flex-column align-items-center"> <!-- Content -->
        ...
        <form style="width: 60%" class="mx-auto my-4 needs-validation" novalidate 
        		method="post" action="<%= request.getContextPath()%>/Admin/Restaurant/Update"> <!-- Update form-->
          <p class="display-6 text-center mb-5">Details</p>
					
					<input name="id" value="<%= restaurant.getId()%>" hidden>
					
          <div class="row mb-3">
            <label for="name" class="col-form-label col-2">Name</label>
            <div class="col-10">
              <input type="text" class="form-control" id="name" name="name" value="<%= restaurant.getName()%>" required>
              <div class="invalid-feedback">
				        Please enter restaurant's name
				      </div>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-10">
              <input type="text" class="form-control" id="contact" name="contact" value="<%= restaurant.getContact()%>" required>
              <div class="invalid-feedback">
          ...
          <div class="row mb-3">
            ...
            <div class="col-10">
              <input type="text" class="form-control" id="owner" name="owner" value="<%= restaurant.getOwner()%>" required>
              <div class="invalid-feedback">
          ...
          <div class="row mb-3">
            ...
            <div class="col-10">
              <textarea class="form-control" id="address" name="address" rows="2" required><%= restaurant.getAddress()%></textarea>
              <div class="invalid-feedback">
                Please enter an address of restaurant
              </div>
            </div>
          </div>
