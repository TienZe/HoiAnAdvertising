...
<head>
  ...
  <title>Hội An &mdash; Đi tìm miền ký ức</title>
</head>

<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200" style="max-width: 100%;">
  ...
  <div class="site-wrap">
    ...
    <main class="main-content">
      ...
      <section class="site-section-hero bg-image mb-5" style="background-image: url('images/HoiAn-hero3.jpg');"
      ...
      <section class="site-section-hero bg-image mb-5" style="background-image: url('images/HoiAn-hero2.jpg');"
        data-stellar-background-ratio="0.5" id="section-home">
        <div class="row fade-half-content justify-content-center align-items-center">
          <div class="col-md-8 text-center">
            <h1 class=" heading text-uppercase text-white" data-aos="fade-up">Mối</h1>
            <h1 class=" heading text-uppercase text-white" data-aos="fade-up">Giao hòa</h1>
            <p class="lead text-white mb-4" data-aos="fade-up" data-aos-delay="100">Tâm thức vượt thời gian
      ...
      <div class="container-fluid site-section">
        ...
        <section class="site-section" id="section-about">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-8">
                <img src="images/HoiAn-Iconic.jpg" alt="Image" class="img-fluid mb-4 w-50 rounded-circle">
            ...
            <div class="row justify-content-center content-justify">
              <div class="col-md-12 d-flex justify-content-auto" data-aos="fade-up" data-aos-delay="100">
                <div class="owl-carousel slide-one-item" id="historic-carousel">
                  <div class="row align-items-center">
                    <div class="col-9 align-items-center d-flex align-items-center justify-content-center">
                      <div class="testimonial d-flex-column">
                    ...
                    <div class="col-3">
                      <img src="images/SaHuynh_period.jpg" alt="Image" class="img-fluid rounded-circle">
                    </div>
                  </div>
                  <div class="row" style="min-height: 249px;">
                    <div class="col-9 align-items-center d-flex align-items-center justify-content-center">
                      <div class="testimonial d-flex-column">
                    ...
                    <div class="col-3">
                      <img src="images/HoiAn-DamcuoiChamPa.jpg" alt="Image" class="img-fluid rounded-circle">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-9 align-items-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-3">
                      <img src="images/HoiAn-ThuongCang2.png" alt="Image" class="img-fluid rounded-circle">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-9 align-items-center d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-3">
                      <img src="images/HoiAn-historic1.jpg" alt="Image" class="img-fluid rounded-circle">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section class="site-section" id="section-testimonial">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h2 class="heading">Cảm niệm Hội An</h2>
                    ...
                    <div class="owl-carousel slide-one-item home-slider">
                      ...
                      <div class="testimony text-center px-md-4">
                        <figure class="mx-auto d-inline-block">
                          <img src="images/person_1.jpg" alt="Free Template by Untree.co"
                      ...
                      <div class="testimony text-center px-md-4">
                        <figure class="mx-auto d-inline-block">
                          <img src="images/person_7.jpg" alt="Free Template by Untree.co"
                            class="mx-auto img-fluid w-25 rounded-circle">
                        </figure>
                      ...
                      <div class="testimony text-center px-md-4">
                        <figure class="mx-auto d-inline-block">
                          <img src="images/person_4.jpg" alt="Free Template by Untree.co"
                            class="mx-auto img-fluid w-25 rounded-circle">
                        </figure>
                      ...
                      <div class="testimony text-center px-md-4">
                        <figure class="mx-auto d-inline-block">
                          <img src="images/person_5.jpg" alt="Free Template by Untree.co"
                            class="mx-auto img-fluid w-25 rounded-circle">
                        </figure>
                      ...
                      <div class="testimony text-center px-md-4">
                        <figure class="mx-auto d-inline-block">
                          <img src="images/person_6.png" alt="Free Template by Untree.co"
                            class="mx-auto img-fluid w-25 rounded-circle">
                        </figure>
                      ...
                      <div class="testimony text-center px-md-4">
                        <figure class="mx-auto d-inline-block">
                          <img src="images/person_8.jpg" alt="Free Template by Untree.co"
                            class="mx-auto img-fluid w-25 rounded-circle">
                        </figure>
        ...
        <section class="site-section" id="section-accommodation">
          <div class="container">
            <div class="justify-content-center" data-aos="fade-up">
